export const NOT_FOUND = 'Запрашиваемые данные не найдены';
...
export const CONFLICT_ERROR = 'Пользователь с такими параметрами уже есть в базе данных';
export const BAD_REQUEST = 'Переданы некорректные данные';
